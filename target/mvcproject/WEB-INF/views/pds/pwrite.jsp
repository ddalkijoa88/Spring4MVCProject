...
<body>
    ...
    <div class="container">
        ...
        <div id="main" style=" margin: 20px 0;">
            <div><i class="fa fa-upload fa-2x"> 자료실</i></div>
            ...
            <!--새글쓰기-->
            <div class="row" style="margin: 10px 30px 20px 50px">
                <form class="card card-body bg-light" name="bdfrm" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group row">
                        <div class="col-1"></div>
                        <label class="col-form-label col-2 text-right" for="title">첨부파일</label>
