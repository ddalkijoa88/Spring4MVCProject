...
<%--<%--%>
    <%--String goIndex = baseurl+"/index.jsp";--%>
    <%--if(isLogin){--%>
...
<div id="main" style=" margin: 20px 0;" >
        ...
        <nav aria-label="breadcrumb" style=" margin: 20px 0;">
            <ul class="breadcrumb">
                ...
                <li class="breadcrumb-item active"><span class="badge badge-light" style="padding:8px">실명확인</span></li>
                <li class="breadcrumb-item active"><span class="badge badge-light" style="padding:8px">정보입력</span></li>
                <li class="breadcrumb-item active"><span class="badge badge-light" style="padding:8px">가입완료</span></li>
        ...
        <div class="card card-body bg-light" style="margin:10px 30px 0 50px">
            <h4>사이트 이용약관</h4>
            <form>
                <div class="form-group">
                    <textarea wrap="hard" rows="10" class="form-control">여러분을 환영합니다.
...
네이버 서비스와 관련하여 궁금하신 사항이 있으시면 고객센터(대표번호: 1588 – 3820/ 평일 09:00~18:00)로 문의 주시기 바랍니다.</textarea>
            ...
            <div class="card card-body bg-light" style="margin:10px 30px 0 50px">
                ...
                <form>
                    <div class="form-group">
                        <textarea wrap="hard" rows="10" class="form-control">정보통신망법 규정에 따라 네이버에 회원가입 신청하시는 분께 수집하는 개인정보의 항목, 개인정보의 수집 및 이용목적, 개인정보의 보유 및 이용기간을 안내 드리오니 자세히 읽은 후 동의하여 주시기 바랍니다.
...
참고로 네이버는 ‘개인정보 유효기간제’에 따라 1년간 서비스를 이용하지 않은 회원의 개인정보를 별도로 분리 보관하여 관리하고 있습니다.</textarea>
                    </div>
                    <div class="custom-control custom-checkbox text-right"  >
        ...
        <div class="text-center" style="margin-top:15px">
            <button class="btn btn-success" type="button" id="agreebtn">모두 동의합니다</button>
            <button class="btn btn-danger" type="button" id="disagreebtn" >동의하지 않습니다</button>
        </div>
...
<!--agreebtb을 클릭하면 일어나는 행동-->
<script>
    $(function(){
        $('#agreebtn').on('click', function(e){location.href='checkme1';});
    });
</script>

<!--disagreebtb을 클릭하면 이전페이지로 이동함-->
<script>
    $(function(){
        $('#disagreebtn').on('click', function(e){history.go(-1);});
    });
</script>
