...
" />
<%--scope="page"는 현재 페이지에서만 사용 가능한 지역 변수를 선언할 때--%>
...
<body>
    ...
    <div class="container">
        ...
        <%--<%--%>
            ...
            <%--if(!isLogin){--%>
                <%--out.print("<script>alert('로그인을 하십시오');</script>");--%>
                <%--out.print("<script>location.href='"+goLogin+"'</script>");--%>
            <%--}--%>
        <%--%>--%>
        ...
        <div id="main" style=" margin: 20px 0;">
            ...
            <div class="row" style="margin: 10px 30px 20px 50px">
                <table class="table">
                    <tr><th colspan="2" style="background-color: #dff0d8; border-bottom: 2px solid black" class="text-center"><h3>${b.subject}</h3></th></tr>
                    <tr style="background-color: #dff0d8;"><td>${b.writer}</td><td class="text-right">${b.regdate} / ${b.views}</td></tr>
                    <tr><td colspan="2" style="border-bottom: 2px solid black">${fn:replace(b.contents, newChar, "<br>")}</td></tr>
                </table>
            </div>
    ...
    <script>
        $(function() {
            $('#checkbtn').on('click', function(e) {
                location.href = '<%=baseurl %>/join/checkme2.jsp';
            });
        });
    </script>
    ...
    <script>
        $(function() {
            $('#newbtn').on('click', function(e) {
                location.href = '<%=baseurl %>/board/write.jsp';
            });
        });
    </script>
        <script>
        $(function() {
            $('#listbtn').on('click', function(e) {
                location.href = '<%=baseurl %>/board/list.jsp';
            });
        });
    </script>
        <script>
        $(function() {
            $('#updatebtn').on('click', function(e) {
                location.href = '<%=baseurl %>/board/modify.jsp';
            });
        });
    </script>
           <script>
